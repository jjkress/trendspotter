...
// Internal: Convert the RootFile and save it to similar named css
//
// On changes this method will be call to convert the RootFile and its imports
// to a single css file (without further optimizations). The resulting file 
// will have the same name as RootFile with less being replaced by css.
// 
// Returns nothing.
